...
[![npm](https://img.shields.io/badge/npm-ipgeo-blue)](https://www.npmjs.com/package/ipgeo-api)
...
```bash
npm install ipgeo-api
```

## Quick Start

```js
import { IPGeoClient } from "ipgeo-api"
...
```js
const { IPGeoClient } = require("ipgeo-api")
```
...
```html
<script type="module">
  import { IPGeoClient } from "https://esm.sh/ipgeo-api"
  const client = new IPGeoClient("ipgeo_YOUR_API_KEY")
</script>
```
